...
begin
    ...
    dpb_inst_0_ADA_i <= gw_gnd & gw_gnd & gw_gnd & gw_gnd & gw_gnd & ada(4 downto 0) & gw_gnd & gw_gnd & gw_vcc & gw_vcc;
    dpb_inst_0_ADB_i <= gw_gnd & gw_gnd & gw_gnd & gw_gnd & gw_gnd & adb(4 downto 0) & gw_gnd & gw_gnd & gw_vcc & gw_vcc;
    dpb_inst_1_BLKSELA_i <= gw_gnd & gw_gnd & gw_gnd;
    dpb_inst_1_BLKSELB_i <= gw_gnd & gw_gnd & gw_gnd;
    dpb_inst_1_ADA_i <= gw_gnd & gw_gnd & gw_gnd & gw_gnd & gw_gnd & ada(4 downto 0) & gw_gnd & gw_gnd & gw_vcc & gw_vcc;
    dpb_inst_1_ADB_i <= gw_gnd & gw_gnd & gw_gnd & gw_gnd & gw_gnd & adb(4 downto 0) & gw_gnd & gw_gnd & gw_vcc & gw_vcc;
    dpb_inst_2_BLKSELA_i <= gw_gnd & gw_gnd & gw_gnd;
    dpb_inst_2_BLKSELB_i <= gw_gnd & gw_gnd & gw_gnd;
    dpb_inst_2_ADA_i <= gw_gnd & gw_gnd & gw_gnd & gw_gnd & gw_gnd & ada(4 downto 0) & gw_gnd & gw_gnd & gw_vcc & gw_vcc;
    dpb_inst_2_ADB_i <= gw_gnd & gw_gnd & gw_gnd & gw_gnd & gw_gnd & adb(4 downto 0) & gw_gnd & gw_gnd & gw_vcc & gw_vcc;
    dpb_inst_3_BLKSELA_i <= gw_gnd & gw_gnd & gw_gnd;
    dpb_inst_3_BLKSELB_i <= gw_gnd & gw_gnd & gw_gnd;
    dpb_inst_3_ADA_i <= gw_gnd & gw_gnd & gw_gnd & gw_gnd & gw_gnd & ada(4 downto 0) & gw_gnd & gw_gnd & gw_vcc & gw_vcc;
    dpb_inst_3_ADB_i <= gw_gnd & gw_gnd & gw_gnd & gw_gnd & gw_gnd & adb(4 downto 0) & gw_gnd & gw_gnd & gw_vcc & gw_vcc;
